...
jQuery(document).ready(function($) {
	...
	$('a#mob-menu-switch').on("click", function(e){
		if ( $('#hidden-mobile-menu').hasClass('active') ){
			...
			if (!$('#site-header').hasClass('first-show-close')) $('#site-header').addClass('first-show-close');
		} else {
	...
	$('#header-hide-btn').on("click", function(e){
		$('#site-header').removeClass('show').removeClass('first-show-open').addClass('first-show-close');
	...
	header_container_width = jQuery('#main-header .container').width();
	header_width = jQuery('#main-header').width();
	header_right_margin = (header_width - header_container_width) / 2;
	...
	} else if (document.body.clientWidth < 758) {
		$('#site-header').addClass('mobile');
	}
...
jQuery(window).on('scroll', function() {	
	...
	if (currScroll > lastScrollTop){	// Scroll Down
		if ( (jQuery(window).scrollTop() > menu_appear_height) && (jQuery(window).scrollTop() < menu_disappear_height) ) {	
			if ( !(jQuery('#site-header').hasClass('show')) && !(jQuery('#site-header').hasClass('first-show-close')) ) {	
				jQuery('#site-header').addClass('show').addClass('first-show-open');
				if (jQuery('#mob-menu-alt-switch').hasClass('active')) jQuery('#mob-menu-alt-switch').removeClass('active');
			}
		} else {
			if ( (jQuery('#site-header').hasClass('show')) && !jQuery('#mob-menu-alt-switch').hasClass('active') && (jQuery('#site-header').hasClass('first-show-open')) )	{	
				jQuery('#site-header').removeClass('show').removeClass('first-show-open').addClass('first-show-close');
		...
		if ( (jQuery(window).scrollTop() > menu_appear_height ) ) {	
			if (jQuery('#site-header').hasClass('first-show-close') && !(jQuery('#site-header').hasClass('show')) ){
				jQuery('#mob-menu-alt-switch').addClass('active');
			}
			if (menu_show_top && jQuery('#hidden-mobile-menu').hasClass('absolute')) {
				jQuery('#hidden-mobile-menu').removeClass('absolute');
				jQuery('#site-header').removeClass('show-top'); 
				if (jQuery('#site-header').hasClass('first-show-close')) {
					jQuery('#hidden-mobile-menu').slideUp(0);
					jQuery('#hidden-mobile-menu').removeClass('active');
					jQuery('#mob-menu-switch').removeClass('active');
				}
		...
		if (jQuery('#site-header').hasClass('show') 
		 && jQuery('#site-header').hasClass('mobile')
		 && jQuery('#site-header').hasClass('first-show-close') 
		 && !jQuery('#hidden-mobile-menu').hasClass('active') ) {
		...
		if (input_focused == false && jQuery(window).scrollTop() > menu_appear_height)  {	
			...
			if (jQuery('#mob-menu-alt-switch').hasClass('active')) {
